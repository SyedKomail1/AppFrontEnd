...
const MainScreen = ({navigation}) => (
    ...
    <Button
      ...
      />
        <View >
          <Text style = {styles.headerText} > Main Get Lost In Beautiful Day
            </Text>
        </View>
...
<Text style= {styles.baseTextL}> Category </Text>
    ...
    <View style={styles.ImageView}  >
       <Image source={require("../src/assets/location2.jpg")} style={styles.Image1} />
      <ImageButton title="Premium"  description="Great Places"/>
    </View >
    </TouchableHighlight>
    <View style={styles.ImageView}>
      <Image source={require("../src/assets/location3.jpg")} style={styles.Image1}/>
   <ImageButton title="Luxury"  description="Stunning Places"/>
    </View >
    <View style={styles.ImageView}>
      <Image source={require("../src/assets/location1.jpg")}  style={styles.Image1}/>
      <ImageButton title="Premium"  description="Great Places"/> 
